...
public class DTHClient {
    ...
    //2. `@Value("${api.remoteClient.dth.signer.url}")`: Anotação Spring que injeta o valor da propriedade especificada
    // no arquivo de configuração (por exemplo, `application.properties`) na variável `clientHost`.
